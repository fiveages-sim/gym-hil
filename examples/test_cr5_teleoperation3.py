...
# python examples/test_cr5_teleoperation3.py --two-cameras
# python examples/test_cr5_teleoperation3.py --step-size 0.1 越大越快，锁z
...
def main():
    ...
    if args.task_env:
        base_env = CR5TaskGymEnv(
            ...
            image_obs=True,
            use_right_wrist_camera=not args.two_cameras,
        )
    else:
